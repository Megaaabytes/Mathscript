        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show($"Script out of memory.", "Mathscript OutOfMemory error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        updatesAvaliable = false;
                    }
                    ...
                    {
                        MessageBox.Show($"A catastrophic failure has occured. Error Message: {ex.Message}", "Mathscript Catastrophic failure.", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        updatesAvaliable = false;
                    }
                    catch (FormatException)
                    {
                        MessageBox.Show($"A format error has occured.", "Mathscript format error.", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        updatesAvaliable = false;
                    }
                    catch (Exception ex)
                    {
